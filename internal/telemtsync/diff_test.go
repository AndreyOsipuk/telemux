...
func TestExpirationEquals(t *testing.T) {
	cases := []struct {
		...
		// Регресс: PG-срок форматируется без долей секунды (RFC3339 роняет мс),
		// нода отдаёт с миллисекундами → НЕ должно давать ложный patch.
		{sptr("2027-06-01T20:45:38Z"), sptr("2027-06-01T20:45:38.657+00:00"), true},
		{sptr("2027-06-01T20:45:38.657Z"), sptr("2027-06-01T20:45:38.657+00:00"), true},
		// Но разница в целую секунду — реально разные сроки.
		{sptr("2027-06-01T20:45:38Z"), sptr("2027-06-01T20:45:39Z"), false},
	}
	for i, c := range cases {
